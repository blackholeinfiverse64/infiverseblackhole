...
function Dashboard() {
  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center h-[80vh] cosmic-background">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900/20 to-slate-900 relative overflow-hidden">
      ...
      {/* Enhanced Space Stats Cards */}
      <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4 relative z-10">
        <Card className="space-card hover:glow-hover group relative overflow-hidden border-primary/20">
          ...
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4 relative z-10">
            ...
            <div className="p-3 hero-gradient rounded-2xl glow-primary group-hover:animate-pulse transition-all duration-300 transform group-hover:scale-110">
              <svg
        ...
        <Card className="space-card hover:glow-hover group border-success/20 hover:border-success/40 transition-all duration-300">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
            <CardTitle className="text-sm font-medium text-muted-foreground">Completed Tasks</CardTitle>
            <div className="p-2 bg-gradient-to-br from-success/20 to-success/30 rounded-lg group-hover:from-success/30 group-hover:to-success/40 transition-all duration-300 glow-secondary">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="none"
          ...
          <CardContent>
            ...
            <p className={`text-sm flex items-center gap-1 ${
              stats.completedTasksChange >= 0 ? 'text-success' : 'text-destructive'
            }`}>
        ...
        <Card className="space-card hover:glow-hover group border-warning/20 hover:border-warning/40 transition-all duration-300">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
            <CardTitle className="text-sm font-medium text-muted-foreground">In Progress</CardTitle>
            <div className="p-2 bg-gradient-to-br from-warning/20 to-warning/30 rounded-lg group-hover:from-warning/30 group-hover:to-warning/40 transition-all duration-300 glow-secondary">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="none"
        ...
        <Card className="space-card hover:glow-hover group border-urgent/20 hover:border-urgent/40 transition-all duration-300">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-muted-foreground">Pending Tasks</CardTitle>
            <div className="p-2 bg-gradient-to-br from-urgent/20 to-urgent/30 rounded-lg group-hover:from-urgent/30 group-hover:to-urgent/40 transition-all duration-300 glow-primary">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="none"
